function createUnityInstance(e, r, n) {
    function o(e, n) {
        if (!o.aborted && r.showBanner)
            return "error" == n && (o.aborted = !0),
            r.showBanner(e, n);
        switch (n) {
        case "error":
            console.error(e);
    ...
    function t(e) {
        ...
        if (o.startsWith(n) && (o = o.substring(n.length)),
        n += "\n" + o.trim(),
    ...
    function i(e, r, n) {
        if (e.indexOf("fullscreen error") == -1) {
            if (c.startupErrorHandler)
                return void c.startupErrorHandler(e, r, n);
    ...
    function s(e, r) {
        if ("symbolsUrl" != e) {
            ...
            "object" != typeof r || "progress" != r.type && "load" != r.type || (o.started || (o.started = !0,
            o.lengthComputable = r.lengthComputable,
            o.total = r.total),
            o.loaded = r.loaded,
            "load" == r.type && (o.finished = !0));
            var t = 0
              , a = 0
              , i = 0
              , s = 0
                    ...
                    for (var t in r) {
                        ...
                        if (c.frameworkUrl.endsWith("." + a[0])) {
                            ...
                            if ("file:" == location.protocol)
                                return void o(i + " Loading pre-compressed (brotli or gzip) content via a file:// URL without a web server is not supported by this browser. Please use a local development web server to host compressed Unity content, or use the Unity Build and Run option.", "error");
                            if (i += ' This can happen if build compression was enabled but web server hosting the content was misconfigured to not serve the file with HTTP Response Header "Content-Encoding: ' + a[1] + '" present. Check browser Console and Devtools Network tab to debug.',
        ...
        c.preRun.push(function() {
            ...
            e.then(function(e) {
                var r = new DataView(e.buffer,e.byteOffset,e.byteLength)
                  , n = 0
                  , o = "UnityWebData1.0\0";
                if (!String.fromCharCode.apply(null, e.subarray(n, n + o.length)) == o)
    ...
    return c.SystemInfo = function() {
        ...
        for (var r, n, o, t, a, i, s = navigator.userAgent + " ", l = [["Firefox", "Firefox"], ["OPR", "Opera"], ["Edg", "Edge"], ["SamsungBrowser", "Samsung Browser"], ["Trident", "Internet Explorer"], ["MSIE", "Internet Explorer"], ["Chrome", "Chrome"], ["CriOS", "Chrome on iOS Safari"], ["FxiOS", "Firefox on iOS Safari"], ["Safari", "Safari"]], d = 0; d < l.length; ++d)
            if (n = e(l[d][0] + "[/ ](.*?)[ \\)]", s, 1)) {
                r = l[d][1];
                break
            }
